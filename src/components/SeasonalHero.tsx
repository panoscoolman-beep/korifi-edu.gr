...
const SEASONS: Record<SeasonKey, HeroSlide[]> = {
  "spring-panellinies": [
    ...
    },
    {
      ...
      headline: "Δια ζώσης ή εξ αποστάσεως,",
      highlight: "ίδια ποιότητα",
      sub: "Δια ζώσης ή εξ αποστάσεως μαθήματα — στο ίδιο μάθημα, ταυτόχρονα.",
  ...
  "summer": [
    ...
    },
    {
      ...
      sub: "Δια ζώσης ή εξ αποστάσεως μαθήματα ώστε να μην χάσεις τις διακοπές σου ούτε την ύλη.",
    ...
    },
    {
      ...
      sub: "Όσοι ξεκινούν Ιούνιο–Ιούλιο χτίζουν γερές βάσεις και κάνουν την κατάλληλη προετοιμασία προκειμένου να είναι έτοιμοι για τη νέα σχολική χρονιά.",
  ...
  "winter-exams": [
    {
      ...
      highlight: "μετράει",
      sub: "Στοχευμένη υποστήριξη για διαγωνίσματα και τετραμηνιαία. Δια ζώσης ή εξ αποστάσεως μαθήματα.",
