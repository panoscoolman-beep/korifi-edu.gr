    ...
    <>
      ...
      {state?.ok ? (
        ...
        <form action={action} className="space-y-4">
          <div>
            <label htmlFor="full_name" className="block text-sm font-medium text-slate-700">Ονοματεπώνυμο</label>
            <input
          ...
          <p className="text-xs text-slate-500">
            Με την εγγραφή συμφωνείς ότι θα λάβεις email επιβεβαίωσης. Μέχρι να επιβεβαιώσεις το email σου,
            δεν θα μπορείς να συνδεθείς.
          </p>
        </form>
      )}
    </>
