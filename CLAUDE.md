...
### 0. ΚΑΝΟΝΑΣ: Διασταύρωση με επίσημες πηγές ΠΡΙΝ από κάθε δημοσίευση

**Κάθε πραγματολογικός ισχυρισμός** σε άρθρο, post, story ή σελίδα (αλλαγές
Πανελληνίων, ΦΕΚ/υπουργικές αποφάσεις, ονομασίες σχολών, βάσεις, ημερομηνίες
εξετάσεων κ.λπ.) **διασταυρώνεται με επίσημη πηγή** (minedu.gov.gr, ΦΕΚ,
ανακοινώσεις πανεπιστημίων) πριν ανέβει — όχι μόνο με δευτερογενή δημοσιεύματα.
Στο τέλος του άρθρου αναφέρεται η πηγή (π.χ. αριθμός ΥΑ/ΦΕΚ).

*Γιατί υπάρχει ο κανόνας:* 29/7/2026 — το άρθρο «Πανελλήνιες 2027» έγραφε
λανθασμένα ότι «η Φυσική προστίθεται ως εξεταζόμενο μάθημα στο 3ο πεδίο».
Το σωστό (ΥΑ Φ.253/47419/Α5, ΦΕΚ Β΄ 2416/2026): η Φυσική ήταν ήδη εξεταζόμενο
μάθημα του προσανατολισμού Υγείας· η αλλαγή είναι ότι οι υποψήφιοι του 3ου
πεδίου αποκτούν πρόσβαση στα **τμήματα Φυσικής** (7 τμήματα) + 2 τμήματα
Μηχανικών Περιβάλλοντος. Επίσης η ΥΑ δεν αλλάζει τίποτα για τομείς ΕΠΑΛ.

*Δεύτερο περιστατικό (ίδια μέρα):* το ίδιο άρθρο παρουσίαζε ως «αλλαγή» την κατάταξη
ΣΣΑΣ Νομικού/Ψυχολογικού στο 1ο πεδίο — όμως αυτή **προϋπήρχε** (υπήρχε ήδη στα
μηχανογραφικά 2024/2025)· η ΥΑ απλώς επαναδιατυπώνει την κατάταξη υπό τον τίτλο
«Στρατιωτικές Σχολές». Δίδαγμα: **επαναδιατύπωση/ανακωδικοποίηση σε ΦΕΚ ≠ νέα αλλαγή** —
πριν γράψεις «αλλάζει», σύγκρινε με το τι ίσχυε ήδη τα προηγούμενα χρόνια.
